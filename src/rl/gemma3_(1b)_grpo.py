...
model_name = os.getenv("DEFAULT_MODEL", "unsloth/gemma-3-1b-it")
hf_token = os.getenv("HUGGINGFACE_TOKEN") # Ensure HUGGINGFACE_TOKEN is in your .env if needed for gated models
