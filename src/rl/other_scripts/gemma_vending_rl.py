# -*- coding: utf-8 -*-
"""gemma-vending-rl.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/111zjTC-zwqGY17fXrgTHTjtpAZf44N1D
...
CLIENT_LAMBDA = 25 # Average clients per week
...
# Disable torch.compile to avoid InductorError related to GPU backend
...
model.push_to_hub(repo_id=f"{account}/gemma-3-vending-rl", token=hf_token)
tokenizer.push_to_hub(repo_id=f"{account}/gemma-3-vending-rl", token=hf_token)
